...
set_property  ip_repo_paths  {./hdl/library ./hls/hls_dab/hls/impl ./hls/hls_dab/hls_dab/hls/impl/ip} [current_project]
update_ip_catalog
set_property  ip_repo_paths  {./hdl/library ./hls/hls_dab/hls_dab/hls/impl/ip} [current_project]
update_ip_catalog
startgroup
